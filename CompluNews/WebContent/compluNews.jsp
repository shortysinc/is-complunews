<%@ page language="java" contentType="text/html; charset=utf-8" import="Objetos.Persona"%>
	...
	<div id="page">
		...
		<div id="sidebar2" class="sidebar">
			<ul>
				...
				<li>
					<h2>Calendario(hay que poner uno)</h2>
					<div id="calendar_wrap">
						<table summary="Calendar">
							...
							<tfoot>
								<tr>
									<td abbr="September" colspan="3" id="prev"><a href="#" title="View posts for September 2013">&laquo; Sep</a></td>
									<td class="pad">&nbsp;</td>
